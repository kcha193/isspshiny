...
datRaw <- read_spss("data/ISSP1995_National_Identity_I_data_set.sav")
...
fullNameForSelect <-
  fullNameForSelect[1:grep("How close feel to your ethnic group",
                           fullNameForSelect)]
...
fullNameList$`1995` <- fullName
fullNameForSelectList$`1995` <- fullNameForSelect
datRawList$`1995` <- datRaw
datList$`1995` <- dat
