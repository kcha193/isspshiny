...
datRaw <- read_spss("data/ISSP2010_Environment_III_data_set.sav")
...
fullNameList$`2010` <- fullName
fullNameForSelectList$`2010` <- fullNameForSelect
datRawList$`2010` <- datRaw
datList$`2010` <- dat
