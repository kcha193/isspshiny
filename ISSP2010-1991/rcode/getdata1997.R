...
datRaw <- read_spss("data/ISSP1997_Work_Orientations_II_data_set.sav")
...
fullNameForSelect <-
  fullNameForSelect[1:grep("Main source of economic support",
                           fullNameForSelect)]
...
fullNameList$`1997` <- fullName
fullNameForSelectList$`1997` <- fullNameForSelect
datRawList$`1997` <- datRaw
datList$`1997` <- dat
