...
datRaw <- read_spss("data/ISSP1996_Role_of_Government_III_data_set.sav")
...
fullNameForSelect <-
  fullNameForSelect[1:(grep("R: sex",
                           fullNameForSelect)-1)]
...
fullNameList$`1996` <- fullName
fullNameForSelectList$`1996` <- fullNameForSelect
datRawList$`1996` <- datRaw
datList$`1996` <- dat
