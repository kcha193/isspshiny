...
datRaw <- read_spss("data/ISSP2001_Social_Networks_II_data_set.sav")
...
fullNameForSelect <-
  fullNameForSelect[1:grep("How often:political discussion w friend",
                           fullNameForSelect)]
...
fullNameList$`2001` <- fullName
fullNameForSelectList$`2001` <- fullNameForSelect
datRawList$`2001` <- datRaw
datList$`2001` <- dat
