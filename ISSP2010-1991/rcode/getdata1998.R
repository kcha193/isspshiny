...
datRaw <- read_spss("data/ISSP1998_Religion_II_data_set.sav")
...
fullNameForSelect <-
  fullNameForSelect[1:grep("Law conflicts with rel. principles",
                           fullNameForSelect)]
...
fullNameList$`1998` <- fullName
fullNameForSelectList$`1998` <- fullNameForSelect
datRawList$`1998` <- datRaw
datList$`1998` <- dat
